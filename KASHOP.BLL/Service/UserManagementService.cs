...
namespace KASHOP.BLL.Service
{
    public class UserManagementService : IUserManagementService
    {
        ...
        public UserManagementService(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IEmailSender emailSender, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<UserDetailsResponse?> GetUser(string userId)
        {
            ...
            result.IsBLocked = user.LockoutEnd.HasValue &&
        ...
        public async Task<bool> ToggleBlockUser(string userId)
        {
            ...
            else
            {
                ...
                await _userManager.SetLockoutEndDateAsync(user, DateTime.UtcNow.AddDays(5));//block
